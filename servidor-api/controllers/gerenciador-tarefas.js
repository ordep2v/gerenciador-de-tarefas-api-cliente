...
let tarefas = [
   ...
   {id: '4', nome: 'Estudar React Hooks', concluida: false}
]
...
function listarTarefas(req, res) {
    ...
    const ordem = req.query['ordem'] // ASC para ascendente, DESC para descendente
    ...
    if(filtroTarefa) {
        tarefasRetornar = tarefasRetornar.filter(
            t => t.nome.toLocaleLowerCase().indexOf(filtroTarefa.toLocaleLowerCase()) === 0
        )
    }
    //ordenar os dados
    if (ordem === 'ASC') {
